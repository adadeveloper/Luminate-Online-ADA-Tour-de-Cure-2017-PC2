...
var onContactAddedListenerAdded = false;
...
var loadRecentActivity = function() {
    ...
    YAHOO.Convio.PC2.Component.RecentActivity.columnDefs = [
        {key: "date", label:YAHOO.Convio.PC2.Component.Content.getMsgCatValue("date_table_header"), className: "recent-activity-date"}, //Date
        {key:"type", label:YAHOO.Convio.PC2.Component.Content.getMsgCatValue("activity_table_header"), formatter: YAHOO.Convio.PC2.Component.RecentActivity.formatType}, //Activity
        {key:"activity", label:YAHOO.Convio.PC2.Component.Content.getMsgCatValue("description_table_header"), className: "recent-activity-detail"}, //Description
        {key:"followup", label:YAHOO.Convio.PC2.Component.Content.getMsgCatValue("additional_info_table_header"), className: "recent-activity-followup", formatter: YAHOO.Convio.PC2.Component.RecentActivity.formatFollowup} //Additional Info
    ];
    ...
    YAHOO.Convio.PC2.Views.load["email"] = function(subview) {
        ...
        if(subview == "compose") {
        	Y.use("pc2-compose-functions", "pc2-contacts-functions",function(Y) {
                ...
                if( onContactAddedListenerAdded == false) {
                    ...
                    onContactAddedListenerAdded = true;
                }
