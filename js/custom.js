...
function handlerHomeProgress(){
	...
	//cta
	jQTCPC2('#so2016ctaADA').load('../site/SPageServer?pagename=TC_2018_PC2_CTA_DH&pgwrap=n&fr_id='+getURLParameter("fr_id")+'&px='+myCID);
	
	//achievement badge
	jQTCPC2('#myachievementADA').load('../site/SPageServer?pagename=TC_2018_Badges_DH&pgwrap=n&fr_id='+getURLParameter("fr_id")+'&px='+myCID, function(){addOnBadgeHandler();});
	
	//dashboard misc
	jQTCPC2('#dashboardmiscADA').load('../site/SPageServer?pagename=TC_2018_PC2_DashboardMisc_DH&pgwrap=n&fr_id='+getURLParameter("fr_id"), function(){customPopup();});
	jQTCPC2('#s51-fundraising-tools').load('../site/SPageServer?pagename=TC_2018_PC2_Tools_DH&fr_id='+myFRID+'&mycid='+myCID+'&pgwrap=n',function(){customMenu(1);});
	jQTCPC2('#s51-go-social').load('../site/SPageServer?pagename=TC_2018_PC2_GoSocial_DH&fr_id='+myFRID+'&mycid='+myCID+'&pgwrap=n' ,function(){customMenu(2);});
	
	
	//evt manager built link
	jQTCPC2('#adanotifevtmgrlink').prop('href','http://main.diabetes.org/site/TR?pg=informational&fr_id='+getURLParameter("fr_id")+'&type=fr_informational&sid=24666');	
