 ...
 * Overriding bind should never be done.
 */
Function.prototype.functionYouShouldNeverUse = function(scope) {
  var _function = this;
...
YAHOO.Convio.PC2.Utils = {
    ...
    require: function() {
        ...
        for( var i = 0; i < arguments.length; i++ ) {
            ...
            if(i+1 == arguments.length && typeof(arguments[i]) == "function") {
                ...
                var fx = myLoader.fn.functionYouShouldNeverUse(myLoader);
    ...
    getMsgCatKeys: function() {
		  ...
		  'contacts_progress_acknowledge_contact_gift_no_email_header', 'contacts_progress_acknowledge_contact_gift_no_email_body',
	          ...
	          'social_share_on_twitter','social_share_on_linkedin','social_share_finished_button',
	          ...
	          'social_share_facebook', 'social_share_linkedin', 'social_share_twitter', 'social_share_yahoo',
			  ...
			  'prev', 'email-wizard-template-type-header',
              /* --------------- Pc2 Table Headers --------------*/
              'date_table_header', 'activity_table_header', 'description_table_header', 'additional_info_table_header',
              'contacts_available', 'email_wizard_recipients_header', 'email_wizard_available_contact_header', 'email_wizard_recipients_template_header',
              'contact_header_picker', 'group_header_picker', 'email_wizard_contacts_name_header', 'email_wizard_contacts_email_header',
              'email_wizard_groups_name_header', 'email_wizard_recipients_name_header', 'email_wizard_recipients_email_header', 'email_wizard_recipients_actions_header',
              'blank_message_header'
	      ];
